 ...
 *
 */
package com.performance.test.mcn.service;
...
import com.performance.test.mcn.activity.MainPageActivity;
import com.performance.test.mcn.http.ServerAdress;
import com.performance.test.mcn.utils.Constants;
import com.performance.test.mcn.utils.CpuInfo;
import com.performance.test.mcn.utils.CurrentInfo;
import com.performance.test.mcn.utils.EncryptData;
import com.performance.test.mcn.utils.FpsInfo;
import com.performance.test.mcn.utils.MailSender;
import com.performance.test.mcn.utils.MemoryInfo;
import com.performance.test.mcn.utils.MyApplication;
...
import com.performance.test.mcn.http.StatisticsUpload;
...
//	private String temperature;
	...
	private StatisticsUpload mStatisticUpload;
		...
		try {
			...
			while ((line = bufferedReader.readLine()) != null) {
				...
				if (line.matches(regex)) {
					...
					Toast.makeText(BaseService.this,
